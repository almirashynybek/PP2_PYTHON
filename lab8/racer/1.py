...
class Enemy(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load("Enemy.png") # load image
...
class Player(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load("Player.png") # load image
        self.rect = self.image.get_rect()
...
class Coin(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load("coin.png") # load image
        self.rect = self.image.get_rect()
...
File "/Users/almirashynybek/Desktop/PP 2/lab8/racer/1.py", line 122, in <module>
    screen.blit(game_over, (0, 0))
